# -*- coding: utf-8 -*-
#
# Extended qatServiceName2 Converter for Enigma2 Dreamboxes (qatServiceName2.py)
...
class qatServiceName2(Converter, object):
	NAME = 0
	NUMBER = 1
	BOUQUET = 2
	PROVIDER = 3
...
#					result += '%.3f'%(((self.tpdata.get('frequency', 0) / 1000) +1) / 1000.0) + " MHz "
	...
	def getIPTVProvider(self, refstr):
		if 'tvshka' in refstr:
			...
			return "Trinity"
		elif '.cn.ru' in refstr or 'qatotelecom' in refstr:
			return "qatotelecom"
